...
export function InsightCard({ story }: InsightCardProps) {
    ...
    const summary = (language === 'zh' && story.summaryZh) ? story.summaryZh : story.summary;
    const interpretation = (language === 'zh' && story.interpretationZh) ? story.interpretationZh : story.interpretation;
    const aiComments = (language === 'zh' && story.aiCommentsZh) ? story.aiCommentsZh : story.aiComments;
